...
if (URL_builtin.URLPattern) {
  ...
  console.log('Pattern methods:', Object.getOwnPropertyNames(Object.getPrototypeOf(pattern)));
  console.log('Result structure:', result ? Object.keys(result) : 'null');
  if (result) {
    console.log('Result.inputs type:', typeof result.inputs, Array.isArray(result.inputs), result.inputs.length);
