...
console.log('Install event promises resolved, installComplete:', installComplete);
...
console.log('Activate event promises resolved, activateComplete:', activateComplete);
