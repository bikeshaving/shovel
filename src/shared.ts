 ...
 */
export function mergeConfig(userConfig: AssetsConfig = {}): Required<AssetsConfig> {
  return {
    ...DEFAULT_CONFIG,
    ...userConfig,
  };
 ...
 */
export function mergeRuntimeConfig(userConfig: RuntimeConfig = {}): RuntimeConfig & Required<AssetsConfig> {
